...
import 'package:maosul/provider/locationDetails.dart';
...
class AppState with ChangeNotifier {
  ...
  // GoogleMapsServices getRouteCoordinates = GoogleMapsServices();
  ...
  // GoogleMapsServices get googleMapsServices => getRouteCoordinates;
...
// ! TO GET THE USERS LOCATION
  void _getUserLocation() async {
   ...
   await GetLocationDetailsAddress.getUserLocation(position.latitude, position.longitude);
    _initialPosition = LatLng(position.latitude, position.longitude);
    print("the latitude is: ${position.longitude} and th longitude is: ${position.longitude} ");
    print("initial position is : ${_initialPosition.toString()}");
    locationController.text = GetLocationDetailsAddress.addressLine.toString();
    notifyListeners();
  }
